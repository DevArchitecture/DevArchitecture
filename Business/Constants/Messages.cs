...
namespace Business.Constants
{
	...
	public static class Messages
	{
		...
		public static string CID => "Tc Kimlik";
		...
		public static string TrueButCellPhone => "Bilgiler doğru. Cep telefonu gerekiyor.";
		...
		public static string TokenProviderException => "Token Provider boş olamaz!";
