...
namespace DataAccess.Concrete.Configurations
{
	public class TranslateEntityConfiguration : IEntityTypeConfiguration<Translate>
	{
		public void Configure(EntityTypeBuilder<Translate> builder)
		{
			...
			builder.Property(x => x.Value).HasMaxLength(10).IsRequired();
			builder.HasData(
				...
				new Translate {Id=21, LangId = 1, Code = "Operation Claim", Value = "Operasyon Yetkileri" },
				new Translate {Id=22, LangId = 2, Code = "Operation Claim", Value = "Operation Claim" },
