	...
	public class TranslateEntityConfiguration : IEntityTypeConfiguration<Translate>
	{
		public void Configure(EntityTypeBuilder<Translate> builder)
		{
			...
			builder.HasData(
				...
				new Translate { Id = 67, LangId = 1, Code = "PasswordUppercaseLetter", Value = "En Az 1 Küçük Harf İçermelidir!" },
				new Translate { Id = 68, LangId = 2, Code = "PasswordUppercaseLetter", Value = "Must Contain At Least 1 Lowercase Letter!" },
