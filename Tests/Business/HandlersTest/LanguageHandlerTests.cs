...
namespace Tests.Business.HandlersTest
{
    ...
    public class LanguageHandlerTests
    {
        ...
        public async Task Language_GetQuery_Success()
        {
            ...
            _languageRepository.Setup(x => x.GetAsync(It.IsAny<Expression<Func<Language, bool>>>())).ReturnsAsync(
                new Language()
...
//}
        ...
        public async Task Language_GetQueries_Success()
        {
            ...
            _languageRepository.Setup(x => x.GetListAsync(It.IsAny<Expression<Func<Language, bool>>>())).ReturnsAsync(
                new List<Language>
                {
        ...
        public async Task Language_CreateCommand_Success()
        {
            ...
            _languageRepository.Setup(x => x.GetAsync(It.IsAny<Expression<Func<Language, bool>>>())).ReturnsAsync(rt);
        ...
        public async Task Language_CreateCommand_NameAlreadyExist()
        {
            ...
            _languageRepository.Setup(x => x.Query()).Returns(new List<Language>
            {
                new()
                {
