...
public class LanguageHandlerTests
{
    ...
    public async Task Language_GetQuery_Success()
    {
        ...
        var handler = new GetLanguageQueryHandler(_languageRepository.Object);
    ...
    public async Task Language_GetQueries_Success()
    {
        ...
        var handler = new GetLanguagesQueryHandler(_languageRepository.Object);
    ...
    public async Task Language_CreateCommand_Success()
    {
        ...
        var handler = new CreateLanguageCommandHandler(_languageRepository.Object);
    ...
    public async Task Language_DeleteCommand_Success()
    {
        ...
        var handler = new DeleteLanguageCommandHandler(_languageRepository.Object);
        var x = await handler.Handle(command, new CancellationToken());
