    ...
    public class ExceptionHandlingTests
    {
        ...
        public async Task Middleware_UnauthorizedAccess_Returns401()
        {
            var middleware = new GlobalExceptionMiddleware(
                (ctx) => throw new UnauthorizedAccessException(), _logger.Object);
        ...
        {
            var middleware = new GlobalExceptionMiddleware(
                (ctx) => throw new ArgumentException("invalid"), _logger.Object);
            await middleware.InvokeAsync(_context);
        ...
        {
            var middleware = new GlobalExceptionMiddleware(
                (ctx) => throw new KeyNotFoundException(), _logger.Object);
            await middleware.InvokeAsync(_context);
        ...
        {
            var middleware = new GlobalExceptionMiddleware(
                (ctx) => throw new Exception("unexpected"), _logger.Object);
            await middleware.InvokeAsync(_context);
        ...
        {
            var middleware = new GlobalExceptionMiddleware(
                (ctx) => throw new InvalidOperationException("conflict"), _logger.Object);
            await middleware.InvokeAsync(_context);
